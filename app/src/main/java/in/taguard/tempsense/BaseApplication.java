...
import in.taguard.tempsense.utils.IOUtils;

public class BaseApplication extends Application {

    private static final String TAG = "taguard";
    private static final String LOG_FILE = "taguard.txt";
    private static final String LOG_FOLDER = "taguard";

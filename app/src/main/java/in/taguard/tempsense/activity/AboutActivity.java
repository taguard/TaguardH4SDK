...
import in.taguard.tempsense.BaseApplication;
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_feedback_log:
                File trackerLog = new File(BaseApplication.PATH_LOGCAT + File.separator + "taguard.txt");
                File trackerLogBak = new File(BaseApplication.PATH_LOGCAT + File.separator + "taguard.txt.bak");
                ...
                StringBuilder mailContent = new StringBuilder("taguard_");
